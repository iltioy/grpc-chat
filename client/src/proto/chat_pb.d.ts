...
export class MessageReuquest extends jspb.Message {
  getId(): number;
  setId(value: number): MessageReuquest;

  getMessage(): string;
  setMessage(value: string): MessageReuquest;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): MessageReuquest.AsObject;
  static toObject(includeInstance: boolean, msg: MessageReuquest): MessageReuquest.AsObject;
  static serializeBinaryToWriter(message: MessageReuquest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): MessageReuquest;
  static deserializeBinaryFromReader(message: MessageReuquest, reader: jspb.BinaryReader): MessageReuquest;
}

export namespace MessageReuquest {
  export type AsObject = {
    id: number,
    message: string,
  }
